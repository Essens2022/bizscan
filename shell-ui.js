...
(function(){
  ...
  function setupFooter(){
    ...
    var html=''
      ...
      +'<a href="https://www.tiktok.com/@bizscan.it" target="_blank" rel="noopener" class="social-badge social-tiktok" aria-label="TikTok"><svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" aria-hidden="true"><path d="M16.6 3c.4 2.3 2 4.1 4.4 4.4v3.1c-1.6.1-3-.4-4.4-1.3v6.6c0 3.3-2.7 5.9-5.9 5.9S4.8 19.1 4.8 15.9c0-3.2 2.6-5.8 5.7-5.9v3.2c-1.4.1-2.5 1.3-2.5 2.7 0 1.5 1.2 2.7 2.7 2.7s2.7-1.2 2.7-2.7V3h3.2Z"/></svg></a>'
