...
function analysisOverview(p){
 ...
 const investPerScaleHtml=`<div class="invest-per-scale"><h4>Investimento iniziale</h4><div class="invest-per-scale-row">${investCol('Piccola','prudente')}${investCol('Media','realistico')}${investCol('Grande','ottimistico')}</div></div>`;
