 ...
 host.innerHTML=`<div class="home18">
  ...
  <section class="home18-section home18-testimonials">
   ...
   <div class="site-fb-actions">
    <div class="feedback-form-card" id="siteFbFormCard"><h3>Lascia il tuo feedback su BizScan</h3><div class="feedback-form-row"><input type="text" id="siteFbName" placeholder="Nome e cognome" maxlength="60"></div><div class="feedback-form-row"><textarea id="siteFbMessage" placeholder="La tua esperienza con BizScan…" maxlength="500" rows="3"></textarea>${emojiRow('siteFbMessage')}</div><div class="feedback-form-row feedback-stars-row"><div class="feedback-star-picker" id="siteFbStarPicker" data-value="0"><span data-star="1">★</span><span data-star="2">★</span><span data-star="3">★</span><span data-star="4">★</span><span data-star="5">★</span></div><button class="btn gold" onclick="submitSiteFeedback()">Invia feedback</button></div><p class="feedback-form-msg" id="siteFbFormMsg"></p></div>
